            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 min-h-[calc(100vh-64px)] flex flex-col justify-center relative z-10">
                <div className="flex flex-col lg:flex-row items-center justify-center gap-16">
                    <div className="w-full lg:w-1/3">
                        <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=1974&auto=format&fit=crop" alt="Mahinuzzaman Shaan" className="rounded-lg shadow-2xl w-full" />
                    </div>
                    <div className="w-full lg:w-2/3 text-center lg:text-left">
                        ...
                        <h2 className="text-5xl md:text-6xl font-bold my-4">
                            ...
                            <span className="bg-gradient-to-r from-green-300 via-emerald-400 to-teal-500 text-transparent bg-clip-text"> Interactive</span>
                            apps <span role="img" aria-label="heart">💖</span>
                        </h2>
